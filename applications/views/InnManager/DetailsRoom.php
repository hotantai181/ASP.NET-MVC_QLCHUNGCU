...
<head>
    ...
    <link href="/mohinhmvc/applications/content/jquery-ui.min.css" rel="stylesheet" />
...
<body>
    <div class="container">
        <div class="form-horizontal">
            <div id="qi-div-toolbar-form">
                ...
                <h2 style="color:#0e4eef;font-size:20px">Thông tin căn hộ</h2>
            </div>
            <div id="qi-panel-search" class="fillterFieldsOneRow" style="background-color:#ddd; font-size:16px">
            

                    <p>Phòng: @t.MAPHONG</p>
                    <p>Số người ở: @t.SONGUOI</p>
                    <p>Tình trạng: @t.TINHTRANGPHONG</p>
                    <p>Giá: @t.GIAPHONG VNĐ</p>

                    <p>Chi nhánh: @cn.TENCN @x.name @q.name @p.name</p>

            </div>

            <div class="qi-div-toolbar-form" style="font-size:16px">
              
                <a class="btn btn-info btn-sm" id="suadv" data-id="@t.MAPHONG">
                    <i class="fas fa-pencil-alt" id="suadv" data-id="@t.MAPHONG">
                    </i>
                    Cập nhật giá phòng
                </a>
                        ...
                        <table class="rgMasterTable rgClipCells" id="ctl00_ContentPlaceHolder1_ctl00_RadGrid1_ctl00" style="width: 100%;font-size:13px ;table-layout: fixed; overflow: hidden; empty-cells: show; font-size:16px;">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">Tên dân cư</th>
                                    ...
                                    <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">Nghề nghiệp</th>
                                    <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">Quốc tịch</th>
                                    <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center; "></th>
                                    <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center; "></th>
                                    <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center; "></th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" class="rgRow">@t.TENCUDAN</td>

                                        <td align="center" class="rgRow">@t.CMND</td>
                                        <td align="center" class="rgRow">@t.SDT</td>
                                        <td align="center" class="rgRow">@t.NGHENGHIEP</td>
                                        <td align="center" class="rgRow">@t.QUOCTICH</td>
                                        <td style="color:blue; cursor:pointer" align="center" class='loadword' id='loadword' data-id="@t.CMND">Bản khai nhân khẩu</td>
                                        <td style="color:blue; cursor:pointer" align="center" class='wordtt' id='wordtt' data-id="@t.CMND">Phiếu thu thập thông tin dân cư</td>


                                        <td style="color:blue; cursor:pointer" align="center" class='wordTTTV' id='wordTTV' data-id="@t.CMND">Tờ khai thay đổi TTCT</td>
    ...
    <div class="bg-modal" id="bgmodal">
        <div class="modal-content">
            ...
            <form action="CapNhatGiaPhong" , "QuanLy" method="post" style="margin-bottom:10px">
                <h3 style="text-align:center; font-size:18px">
                    Cập nhật giá phòng
                </h3>
                <h5>Mã phòng &nbsp  <input class="form-control" type="text" name="map" id="map" /></h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('click', '.wordtt', function () {
                var id = $(this).data('id');
                TTTT(id);
            });
            $('body').on('click', '.wordTTTV', function () {
                var id = $(this).data('id');
                TTTV(id);
            });

            $('body').on('click', '#suadv', function () {
                var id = $(this).data('id');
                GetDataById(id);
