        ...
        <div>
            ...
            <div class="form-horizontal">
                <div id="qi-div-toolbar-form">
                    <h4 id="ContentPlaceHolder1_ctl00_lbTieuDe"><span class="iconPage"></span><span style="float: left;font-size:16px">Cập nhật chỉ số điện</span></h4>
                    <div class="clear"></div>
                </div>
                ...
                <div id="qi-panel-search" class=" qi-div-toolbar-form text-left" style="padding-left:10px">
                    <div class="row">
                        ...
                        <div class="col-md-6" style="float:right">
                            <input type="submit" value="Cập nhật chỉ số điện" id="btnLuu" class="btn btn-success qi-bt " style="height:fit-content;float:right" onclick="location.href='#" />
                        </div>
                    </div>
                </div>
