        ...
        <div>
            ...
            <div class="form-horizontal">
                <div id="qi-div-toolbar-form">
                    <span id="ContentPlaceHolder1_ctl00_lbTieuDe"><span class="iconPage"></span><span style="float: left;font-size:16px">Quản lý hóa đơn</span></span>
                    <div class="clear"></div>
                </div>
                <div class=" qi-div-toolbar-form text-left" style="font-size:14px;padding-left:10px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="float:right">
                            <input type="submit" value="Tạo hóa đơn" id="btnLuu" class="btn btn-success qi-bt " style="height:fit-content;float:right" onclick="location.href='@Url.Action("TaoHoaDonTD","QuanLy")'" />
                        </div>
                    </div>  
                </div>
            </div>
                    ...
                    <div id="ctl00_ContentPlaceHolder1_ctl00_RadGrid1" class="RadGrid RadGrid_Bootstrap" tabindex="0">
                        ...
                        <div class="rgHeaderWrapper">
                            <div id="ctl00_ContentPlaceHolder1_ctl00_RadGrid1_GridHeader" class="rgHeaderDiv" style="overflow: hidden; margin-right: 17px;">
                                ...
                                <table class="rgMasterTable rgClipCells" id="ctl00_ContentPlaceHolder1_ctl00_RadGrid1_ctl00" style="width: 100%;font-size:13px ;table-layout: fixed; overflow: hidden; empty-cells: show; font-size:16px;">
                                    ...
                                    <thead>
                                        <tr>
                                            <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">Số phòng</th>
                                            <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">Tên chủ thuê</th>
                                            <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">Tháng</th>
                                            <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">Tổng tiền</th>
                                            <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">CT hóa đơn</th>
                                        </tr>
                                    </thead>
                        ...
                        <div class="bg-modal" id="bgmodal">
                            <div class="modal-content">
                                ...
                                <form action="CapNhatHoaDon" , "QuanLy" method="post" style="margin-bottom:10px">
                                    <h3 style="text-align:center; font-size:18px">Chi tiết hóa đơn / thêm dịch vụ</h3>
                                    <h5>Mã hóa đơn &nbsp  <input class="form-control" type="text" name="mahd" id="mahd" /></h5>
                                    <table class="rgMasterTable rgClipCells" id="ctl00_ContentPlaceHolder1_ctl00_RadGrid1_ctl00" style="width: 100%;font-size:13px ;table-layout: fixed; overflow: hidden; empty-cells: show; font-size:16px;">
                                        <colgroup>
                                        ...
                                        <thead>
                                            <tr>
                                                <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">Tên dịch vụ</th>
                                                <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">Số tiêu thụ</th>
                                                <th scope="col" class="rgHeader qi-head-list-grid" style="text-align:center;">Giá tiền</th>
                                            </tr>
                                        </thead>
                                        <tbody id="tableModal">
                                        </tbody>
                                    </table>
                                    <h5>Tổng tiền &nbsp<input class="form-control" type="text" name="ttien" id="ttien" /> </h5>


                                    <h5>Trạng thái &nbsp <input class="form-control" type="text" name="tthai" id="tthai" /></h5>

                                    <h5>Ngày thanh toán &nbsp   <input class="form-control" type="text" name="ntt" id="ntt" /></h5>


                                    <input type="submit" class="btn btn-success qi-bt " style="float:right" value="Cập nhật" />
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(response, function (i, item) {
                        ...
                        html += "<td align='center' class='rgRow'>" + item.TENDANCU + "</td>";
                        html += "<td align='center' class='rgRow'>"  +item.THANGLAP + "/"+  item.NAMLAP + "</td>";
                        html += "<td align='center' class='rgRow'>" + item.TONGTIEN + "</td>";
                        html += "<td align='center'><img src='../images/edit.png'/ style='cursor: pointer' class='loadword' id='loadword' data-id='" + item.MAHD + "'></td>";
                        html += "</tr>";
                    });
                    $('#tablebody').html(html);
                }
        ...
        function GetDataById(id) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(response, function (i, item) {
                        $('#mahd').val(item.MAHD);
                        $('#ttien').val(item.TONGTIEN);
                        $('#tthai').val(item.TRANGTHAI);
                        $('#ntt').val(item.NTT);              
                        html += "<tr>";
                        html += "<td align='center' class='rgRow'>" + item.TENDV + "</td>";
                        html += "<td align='center' class='rgRow'>" + item.SOTIEUTHU + "</td>";
                        html += "<td align='center' class='rgRow'>" + item.GIATIEN + "</td>";
                        html += "</tr>";
